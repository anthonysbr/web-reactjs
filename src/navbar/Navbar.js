...
function Navbar() {
    ...
    return (
        <nav className="navbar fixed-top navbar-expand-lg navbar-light bg-dark font">
            <div className="navbar-brand orange">ASBR</div>
            ...
            <div className="collapse navbar-collapse">
                <div className="navbar-nav">
                    ...
                    <Link to="#" className="nav-item nav-link active orange">CV Download</Link>
                </div>
            </div>
            ...
            <div className={open !== true ? "sidenav sidenavClosed" : "sidenav sidenavOpen"}>
                ...
                <Link to="#" onClick={()=>setOpen(!open)}>CV Download.</Link>
            </div>
